...
const OrderProcessed: React.FC<OrderProcessedProps> = ({ basket, setShowOrderProcess, showService, type }) => {
                ...
                <div className="flex w-full items-center justify-between gap-5">
                    ...
                    <p className="font-semibold text-xl">
                        ...
                        {formatRupiah(basket?.subtotal)}
                            ...
                            {Number(basket.reduce((acc, curr) => acc + curr.price * curr.quantity, 0)).toLocaleString("id-ID", {
                        style: "currency",
                        currency: "IDR",
                    })}
                        </> }
