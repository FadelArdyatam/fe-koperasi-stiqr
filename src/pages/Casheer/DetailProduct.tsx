    ...
    return (
        <div className="flex w-full flex-col min-h-screen items-center bg-orange-50">
                ...
                {variants.map((variant, index) => (
                    <div key={index}>
                        ...
                        <div className="flex flex-col w-full gap-5">
                            {variant.multiple_value.split(",").map((value: string, index: number) => (
            ...
            <div className="w-[90%] bg-white p-5 rounded-lg shadow-lg mt-5">
                ...
                <textarea onChange={(e) => setNotes(e.target.value)} className="w-full border border-gray-500 mt-5 rounded-lg p-2" placeholder="Tulis catatan untuk pesananmu" name="" id=""></textarea>
            </div>
            ...
            <div className="fixed bottom-0 w-full bg-white p-5 flex items-center justify-between">
                        ...
                        <button
                            onClick={() => {
                                if (quantity > 1) {
                                    ...
                                    setPrice((quantity - 1) * product.product_price); // Update harga
                                }
                            }}
                ...
                <div className="flex flex-col items-end gap-3">
                    {/* Total Harga */}
                    <p className="font-semibold text-xl">{Number(price).toLocaleString("id-ID", {
                        style: "currency",
                        currency: "IDR",
                    })}</p>
