...
const LoansInstallments: React.FC = () => {
  return (
    <div className="pb-20">
      <h2 className="text-2xl font-bold mb-4">Angsuran</h2>
      <p>Placeholder: daftar cicilan dan pencatatan pembayaran akan ditempatkan di sini.</p>
